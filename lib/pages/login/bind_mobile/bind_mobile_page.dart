...
class _BindMobilePageState extends State<BindMobilePage> {
  ...
  Widget _body(context) {
    ...
    return GestureDetector(
      ...
      child: Padding(
        padding:
            EdgeInsets.only(left: 35.w, right: 35.w, top: 90.h), // 设置左右边距为15.0
        child: Column(
          children: [
            SizedBox(
              height: 10.h,
              ...
              child: TextButton(
                onPressed: () async {
                  ...
                  TBHttpResponse response = await TBHttpRequest.post(
                      TBUrl.kBindMobileUrl, context, params: {
                    "code": code,
                    "mobile": phone,
                    "area": _area,
                    "changeToken": ""
              ...
              children: [
                TextButton(
                  onPressed: () {
                    ...
                    TBRouterHelper.pathPage(TBRouterPath.bindProblem, params);
                  },
                  child: Text(
                    'binding problem'.tr,
                    style: TextStyle(color: themed.theme_c.buttonBgColor),
