...
class TBRecordPlugin {
  ...
  static Future<dynamic> _handler(MethodCall methodCall) async{
    // print("--------TBRecordPlugin " + methodCall.method);

    String id = (methodCall.arguments as Map)['id'];
    TBRecordPlugin recordPlugin = alis[id] ?? TBRecordPlugin();
