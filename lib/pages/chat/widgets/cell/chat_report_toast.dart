...
class TBReportToast extends StatefulWidget {
  /// 标题
  final String title;
  ...
  @override
  _TBReportToastState createState() => _TBReportToastState();
}

class _TBReportToastState extends State<TBReportToast> {
  ...
  @override
  void didUpdateWidget(TBReportToast oldWidget) {
    _enable = widget.config.isConfirmButtonEnabled;
    ...
    if (widget.config.showConfirmButton) {
      return Padding(
        ...
        child: BrnBigMainButton(
          bgColor: TBDefVal.chatThemePinkColor,
