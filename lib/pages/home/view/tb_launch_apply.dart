...
class TBLaunchApply extends StatelessWidget {
  /// 按钮点击事件
  final Function(int type)? itemTapAction;

  TBLaunchApply({Key? key, this.itemTapAction}) : super(key: key);
  ...
  Widget body() {
    return Column(
      children: [
        // 上方是一个左图右文
        Container(
          margin: EdgeInsets.only(left: 25.w, right: 25.w, top: 12.w, bottom: 12.w), // 适当调整边距
          child: Row(
            children: [
              // 左图
